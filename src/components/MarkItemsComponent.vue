  ...
  >
    <div class="bg-light rounded row m-0 g-5 pb-5">
      ...
      <section class="col-xl-4 d-flex">
        <div class="col-12">
          <label for="net_weight" class="form-label fw-bold ps-1 d-flex col-12">
            <div class="pe-1 d-flex align-items-center">
              <i class="text-danger fst-normal">＊</i>
            </div>
            每一份成品淨重？
      ...
      <section class="col-xl-4">
        <label for="product_quantity" class="form-label fw-bold ps-1 d-flex">
          <div class="pe-1 d-flex align-items-center">
            <i class="text-danger fst-normal">＊</i>
          </div>
          本包裝含幾份成品？
      ...
      <section class="col-xl-4">
        ...
        <p class="fw-bold mb-2" @click="keyin">含有以下哪些過敏原（ 複選 ）</p>
        <div
